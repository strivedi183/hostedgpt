...
## Project Overview
HostedGPT is a Ruby on Rails 8.1 application providing a multi‑provider conversational AI UI (OpenAI, Anthropic, Groq, Google Gemini, others via OpenAI-compatible APIs). Users can:
